---
title: LDAP (Server Pro)
description: The ability to use a LDAP server to manage users.
sidebar_position: 9
---
...
LDAP is configured in the Toolkit via [`variables.env`](./configuration.mdx).
