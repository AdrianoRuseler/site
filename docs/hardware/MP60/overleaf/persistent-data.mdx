...
description: The Overleaf Toolkit needs to store persistent data.
sidebar_position: 10
---
...
To avoid this error, the data needs to be stored in a volume rather than a bind mounted directory (see [the `mongo` image documentation for more details](https://github.com/docker-library/docs/blob/master/mongo/content.mdx#where-to-store-data)).
