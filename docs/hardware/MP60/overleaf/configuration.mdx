...
description: Configuration files that are used to configure the Overleaf Toolkit.
sidebar_position: 16
---
...
See [The full specification](./overleaf-rc.mdx) for more details on the supported options.
