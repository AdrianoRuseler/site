---
title: Overview
description: Overleaf Toolkit Overview.
sidebar_position: 2
---
...
The `README.mdx` file contains some important information about the project. The `lib/` directory contains files that are internal to the toolkit, and users should not need to worry about.
